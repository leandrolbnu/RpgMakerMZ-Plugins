/*:
 * @target MZ
 * @plugindesc [v1.0] Quest Data Storage – Defines quests, descriptions, rewards, 
 * XP, and sound effects | By JosoGaming
 * @author JosoGaming
 *
 * @help
 * ============================================================================
 * 🔧 JosoQuestSystem_Data – QUEST DATA STORAGE
 * ============================================================================
 *
 * Defines all quests used in the Simple Quest System.
 * Must be loaded **before** the main Quest System plugin.
 *
 * ----------------------------------------------------------------------------
 * 🧩 How to Define Quests:
 * ----------------------------------------------------------------------------
 * Use the global `QuestData` object to store quests. Each entry follows this structure:
 *
 * "quest_id": {
 *   name: "Quest Title",                     // Title shown in Quest Log
 *   description: "Quest description text.",  // Full description
 *   required: 5,                             // Amount of progress required
 *   xp: 100,                                 // XP awarded on completion
 *   rewards: [                               // Array of rewards
 *     { type: "item", id: 1, amount: 3 },
 *     { type: "gold", amount: 200 }
 *   ],
 *   completeSe: "Chime2"                     // (Optional) SE on turn-in
 * }
 *
 * ----------------------------------------------------------------------------
 * 🎁 Reward Types:
 ...
 * ----------------------------------------------------------------------------
 * - Use `completeSe` to specify a SE to play on quest completion.
 * - The sound must exist in `/audio/se/` folder.
...
//=============================================================================
// Quest Data - Defines quests, descriptions, XP, rewards, and completion sound
//=============================================================================
var QuestData = {
  gather_apples: {
    name: "Gather Apples",
